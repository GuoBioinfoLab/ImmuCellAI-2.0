# Complete original seven-method comparison for GSE176078.
...
if (!exists("bulk_file", inherits = FALSE)) {
  bulk_file <- file.path(data_dir, "GSE176078_simulate_variable_background.txt")
}
...
if (!exists("out_dir", inherits = FALSE)) {
  out_dir <- file.path("benchmarks", "output", "fig2", "GSE176078")
}
